...
@if ($posts->count() > 0)
    ...
    <div class="card mb-3">
        ...
        @else  
        <img src="https://picsum.photos/seed/picsum/1200/400" class="card-img-top" alt="{{ $posts[0]->category->name }}">
        @endif
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="position-absolute bg-dark px-3 py-2 text-white" style="background-color: rgba(0, 0, 0.7)  "><a href="/blog?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
                @if ($post->image)
